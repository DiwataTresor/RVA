...
{
	if($("#aa i").hasClass('fa-minus-square'))
	{
		$aa="N";
	}else
	{
				...
				for(var a=0;a<r.length;a++)
				{
					...
					.append("<tr class='w3-hover-grey w3-hover-white-text'>"+
						...
						'<td>'+
							...
							'<a title="Modifier" href="#" class="circle blue p-05 white-text"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp'+
							'<a title="Supprimer" href="#" class="circle red p-05 white-text" onclick="del('+"'"+"handling_facturation"+"'"+","+"'"+"Id_fact"+"'"+","+"'"+r[a]['id']+"'"+","+"'"+$msg+"'"+","+"'"+"paiement_liste_fact"+"'"+')"><i class="fa fa-times"></i></a>'+
						'</td>'+
					"</tr>");
				}
			}
				...
				for(var a=0;a<r.length;a++)
				{
					...
					.append("<tr class='w3-hover-grey'>"+
						...
						"<td>"+
							...
							'<span class="circle red white-text p-05"><a href="#" class="white-text" title="Supprimer"><i class="fa fa-times"></i></a></span>&nbsp;'+
						"</td>"+
					"</tr>");
				}
			}
