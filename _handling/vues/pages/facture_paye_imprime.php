<?php
	...
	$s="select * from facture_paye_imprime where Valide='V' order by Id_impr desc";
		...
		{ 
			...
			<tr class="w3-hover-grey">
                ...
                <td><?php echo ($user['nom']); ?></td>
                 <td>
                 	<a href="#" onClick="reimprimer_fact_paye_conf(<?php echo $t['Mouv']; ?>);"><i class="fa fa-print"></i> Imprime</a>&nbsp;
