            ...
            <?php
				...
				do
				{
					echo "<tr class=''>";
						...
						echo ("<td class=' center'>".Datemysqltofr($mouvement['ta']['Date_mouv'])."</td>");
						echo ("<td class=' center'>".$mouvement['ta']['Heure_mouv']."</td>");
            ...
            <?php
				...
				do
				{
					echo "<tr class=''>";
						...
						echo ("<td class=' center'>".Datemysqltofr($mouvement['td']['Date_mouv'])."</td>");
						echo ("<td class=' center'>".$mouvement['td']['Heure_mouv']."</td>");
						echo ("<td class=' center'>".$t['Code_pt']."</td>");
						echo ("<td class=' center'>".$t['Ad']."</td>");
						echo ("<td class=' center'>".$t['Ch']."</td>");
						echo ("<td class=' center'>".$t['Inf']."</td>");
...
<table width="1098" height="104" border="0" cellspacing="0" class="w3-small w3-table-all">
  ...
  <tr>
    <td>A</td>
    <td><?php echo arrondie($mouvement['red_route_a']); ?></td>
    <td>&nbsp;</td>
    <td><?php echo arrondie($mouvement['red_bal_a']); ?></td>
    <td><?php echo arrondie($mouvement['red_fret_a']); ?></td>
    <td><?php echo arrondie($mouvement['red_pass_a']); 
  ...
  <tr>
    <td>D</td>
    <td><?php echo arrondie($mouvement['red_route_d']); ?></td>
    <td><?php echo arrondie($mouvement['red_att']); ?></td>
    <td><?php echo arrondie($mouvement['red_bal_d']); ?></td>
    <td><?php echo arrondie($mouvement['red_fret_d']); ?></td>
    <td><?php echo arrondie($mouvement['red_pass_d']); ?></td>
    <td><?php echo arrondie($mouvement['red_pec']); ?></td>
    <td><?php echo arrondie($mouvement['red_stat']); ?></td>
    <td><?php echo arrondie($mouvement['red_compt']); ?></td>
    <td><?php echo arrondie($mouvement['red_formu']); ?></td>
    <td><?php echo arrondie($mouvement['red_assantinc']); ?></td>
    <td><?php echo arrondie($mouvement['red_surete']); ?></td>
    <td><?php echo arrondie($mouvement['red_securite']); ?></td>
  </tr>
  <tr class="red lighten-3">
    <td>&nbsp;</td>
    <td><?php echo arrondie($mouvement['tot_red_rout']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_att']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_bal']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_fret']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_pass']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_pec']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_stat']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_compt']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_formu']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_assantinc']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_surete']); ?></td>
    <td><?php echo arrondie($mouvement['tot_red_securite']); ?></td>
  </tr>
</table>
<div class="row p-1">
...
<div class="w-50 center">
	<table class="w3-table-all w3-small">
    	<tr>
        	<td colspan="2" class="bold">Taux de <?php echo $mouvement['taux']['Usd_fc']; ?> </td> <td></td> <td></td>
        </tr>
        <tr>
        	<td>Montant hors taxe</td> 
            <td><span class="bold blue fs-1 p-1 white-text m-1"><?php echo arrondie($mouvement['tot_sans_tva']); ?></span></td>
            <td>Equivalent a </td> 
            <td><span class="bold blue fs-1 p-1 white-text m-1"><?php echo arrondie($mouvement['tot_sans_tva_fc']); ?></span></td>
        </tr>
        <tr>
        	<td>Montant TVA</td> 
            <td><span class="bold blue fs-1 p-1 white-text m-1"><?php echo arrondie($mouvement['tva']); ?></span></td>
            <td>Equivalent a </td> 
            <td><span class="bold blue fs-1 p-1 white-text m-1"><?php echo arrondie($mouvement['tva_fc']); ?></span></td>
        </tr>
        <tr>
        	<td>Montant Toutes taxes</td> 
            <td><span class="bold blue fs-1 p-1 white-text m-1"><?php echo ($mouvement['tot_avec_tva']); ?></span></td>
            <td>Equivalent a </td> 
            <td><span class="bold blue fs-1 p-1 white-text m-1"><?php echo arrondie($mouvement['tot_avec_tva_fc']); ?></span></td>
        </tr>
    </table>
</div>
