	...
	//=============================== CONTENU DU TABLEAU=================================
			...
			if($n!==0)
			{
				...
				do
				{
					...
					$pdf->Cell(144,8, utf8_decode("POIDS MAX. AU DECOLLAGE : ".$m['ta']['Poids']),'TBR','','L'); 
					$pdf->SetFont('Arial','',7);
						...
						/************* check dans la table de paiement **********************/
							...
							}else
							{
								...
								/*=====================================*/
									...
									$pdf->Cell(18,5, utf8_decode(Datemysqltofr($mouvement2['ta']['Date_mouv'])),'RL','','C'); 
									$pdf->Cell(14,5, utf8_decode(($mouvement2['ta']['Heure_mouv'])),'RL','','C');
									$pdf->Cell(14,5, utf8_decode($mouvement2['ville_arr']),'RL','','C');
									$pdf->Cell(14,5, utf8_decode("FZQA"),'RL','','C');
									$pdf->Cell(10,5, utf8_decode($t_e_a['ad']),'RL','','R');
									$pdf->Cell(10,5, utf8_decode($t_e_a['ch']),'RL','','R');
									$pdf->Cell(10,5, utf8_decode($t_e_a['inf']),'RL','','R');
									$pdf->Cell(10,5, utf8_decode($t_e_a['pec']),'RL','','R');
									$pdf->Cell(14,5, utf8_decode($t_e_a['loc']),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_route_a'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_att'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_bal_a'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_fret_a'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_pass_a'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_stat'])),'RL','','R');
									$pdf->Cell(10,5, "",'RL','','R');
									...
									$pdf->Cell(20,5, utf8_decode(arrondie($mht)),'RL','','R');
								...
								$pdf->Ln();	
									...
									$pdf->Cell(14,5, utf8_decode(($mouvement2['td']['Heure_mouv'])),'RL','','C');
									$pdf->Cell(14,5, utf8_decode("FZQA"),'RL','','C');
									$pdf->Cell(14,5, utf8_decode($mouvement2['ville_dep']),'RL','','C');
									$pdf->Cell(10,5, utf8_decode($t_e_d['ad']),'RL','','R');
									$pdf->Cell(10,5, utf8_decode($t_e_d['ch']),'RL','','R');
									$pdf->Cell(10,5, utf8_decode($t_e_d['inf']),'RL','','R');
									$pdf->Cell(10,5, utf8_decode($t_e_d['pec']),'RL','','R');
									$pdf->Cell(14,5, utf8_decode($t_e_d['loc']),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_route_d'])),'RL','','R');
									$pdf->Cell(10,5, "",'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_bal_d'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_fret_d'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_pass_d'])),'RL','','R');
									$pdf->Cell(10,5, "",'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_surete'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_securite'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_formu'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_compt'])),'RL','','R');
									$pdf->Cell(10,5, utf8_decode(arrondie($mouvement2['red_assantinc'])),'RL','','R');
					...
					$pdf->Cell(14,5, arrondie($fret_kg_ligne),'LTRB','','R'); 
					$pdf->Cell(10,5, arrondie($route_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($atterrissage_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($bal_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($fret_ligne),'RLRT','','R');
					$pdf->Cell(10,5, arrondie($pax_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($stat_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($surete_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($securite_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($formu_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($compt_ligne),'RLT','','R');
					$pdf->Cell(10,5, arrondie($ass_ligne),'RLT','','R');
					$pdf->Cell(20,5, utf8_decode(arrondie($tot_mht_ligne)),'RLT','','R');
					$pdf->Cell(20,5, utf8_decode(arrondie($tot_tva_ligne)),'RLT','','R');
					$pdf->Cell(20,5, utf8_decode(arrondie($tot_mttc_ligne)),'RLT','','R');
				...
				$pdf->Cell(10,6, arrondie($ad),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($ch),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($inf),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($pec),'TRLB','','R');
				$pdf->Cell(14,6, arrondie($fret),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($route),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($atterrissage),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($bal),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($fret),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($pax),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($stat),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($surete),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($securite),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($formu),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($compt),'TRLB','','R');
				$pdf->Cell(10,6, arrondie($ass),'TRLB','','R');
				$pdf->SetFont('Arial','',7);
				$pdf->Cell(20,6, arrondie(ceil($tot_mht)),'TRLB','','R');
				$pdf->Cell(20,6, arrondie(ceil($tot_tva)),'TRLB','','R');
				$pdf->Cell(20,6, arrondie(ceil($tot_mttc)),'TRLB','','R');
