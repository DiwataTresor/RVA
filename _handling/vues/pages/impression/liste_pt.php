<?php
	...
	$pdf->Text(20, 275, utf8_decode("N° IMPOT : A1201438C"));*/
			...
			$type=$_GET['t'];
			$s="select * from pt_emplacement where Type='$type' order by Lib_pt";
			...
			{
				$pdf->Cell(30,7, "",'','','C');
				$pdf->Cell(30,7, $t['Code_pt'],'LRBT','','L');
				$pdf->Cell(75,7, $t['Lib_pt'],'LRBT','','L');
				$pdf->Cell(25,7, $t['Distance']." km",'RBT','','R');
