<?php
	...
	$pdf->Text(10, 32, utf8_decode("----------------------------------------------------------------------"));
			...
			$pdf->Cell(210,7, utf8_decode("BORDEREAU HANDLING/PERIODE "),'','','C'); 
			$pdf->Ln();
...
//================================= DONNEES RETOURNEES DU BORDEREAU==================
			...
			$s="select * from handling_paiement where Date_paie between '$dt' and '$dt2'";
				...
				do
				{
					...
					$st_c_tt=$st_c_tt+0;
						...
						$pdf->Ln();
							...
							$nom=$data['handleur'];	
							$pdf->Cell(50,5,$data_paie["num_fact"],'L','','L');
							...
							$pdf->Cell(20,5,arrondie(0),'R','','R');
							$pdf->Cell(27,5,$data_paie["quittance"],'R','','C');
