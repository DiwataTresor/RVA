	...
	if($_SESSION['Priv']=='adm' || $_SESSION['Priv']=='ch_serv')
	{
		switch($ent)
		{
			...
			case "handleur":
				...
				$code=$m->format_text($_POST['code']);
				$nom=$m->format_text($_POST['nom']);
				$telephone=$m->format_text($_POST['telephone']);
				$adresse=$m->format_text($_POST['adresse']);
				$ville=$m->format_text($_POST['ville']);
				$type_paie=$m->format_text($_POST['type_paie']);
				$nationalite=$m->format_text($_POST['nationalite']);
				$s="update rva_facturation2.handling_handleur
					set 
						Code_hand='$code',
						Nom_hand='$nom',
						Adresse_hand='$adresse',
						Ville_hand='$ville',
						Telephone_hand='$telephone',
						Type_paie='$type_paie',
