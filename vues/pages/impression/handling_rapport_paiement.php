<?php
	...
	$pdf->Text(10, 32, utf8_decode("----------------------------------------------------------------------"));
			...
			$s="select * from handling_paiement where Date_paie between '$dt1' and '$dt2'";
			...
			}else
			{
				...
				do
				{
							...
							$fact=handling_facture($t['Fact_paie'],$bdd);
							$paie=paie_handling_detail($t['Fact_paie'],$bdd);
							$pdf->Ln();
							...
							$pdf->Cell(20,7, arrondie($paie['mht']),'','','C'); 
							$pdf->Cell(15,7, arrondie($paie['tva']),'','','C');
							$pdf->Cell(30,7, arrondie($paie['mttc']),'','','C'); 
