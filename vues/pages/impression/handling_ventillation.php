<?php
	...
	$pdf->Text(10, 32, utf8_decode("----------------------------------------------------------------------"));
			...
			$s="select * from handling_facturation where Date_fact between '$dt1' and '$dt2'";
			...
			$pdf->Cell(280,7, utf8_decode("VENTILLATION DES FACTURES HANDLING"),'','','C'); 
			$pdf->Ln();
			$pdf->SetFont('Arial','',9);
			...
			}else
			{
				...
				$pdf->Cell(20,7, utf8_decode("AA"),'TB','','C'); 
				$pdf->Cell(20,7, utf8_decode("TA"),'TB','','C'); 
				$pdf->Cell(20,7, utf8_decode("FA"),'TB','','C'); 
				...
				do
				{
							...
							$pdf->Cell(20,7, arrondie($fact['aa_prix']),'','','C'); 
							$pdf->Cell(20,7, arrondie($fact['ta_prix']),'','','C'); 
							$pdf->Cell(20,7, arrondie($fact['fa_prix']),'','','C'); 
				...
				$pdf->SetFont('Arial','B',8);
				$pdf->Ln();
				$pdf->Cell(216,7, utf8_decode("TOTAL   "),'TB','','C'); 
