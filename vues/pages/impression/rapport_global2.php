<?php
	...
	//================================ SQL==================================
			...
			$s="select  
					Distinct(immatriculation.Code_imm),
					mouvement2.Immatr,
				...
				and 
					client.Id_cl='$cl' 
				and
					mouvement2.Date_mouv between '$dt' and '$dt2'
				order by 
					immatriculation.Code_imm";
			$e=$m->cnx->query($s); 
			$t=$e->fetchAll(); 
	...
	//=============================== CONTENU DU TABLEAU=================================
			...
			if($n!==0)
			{
				...
				foreach($t as $row)
				{
					...
					$pdf->Cell(15,5, $m->arrondie($tot_tva_ligne),'RLT','','R');
					$pdf->Cell(10,5, $m->arrondie($arrondie_ligne),'RLT','','R');
					$pdf->Cell(20,5, $m->arrondie($tot_mttc_ligne),'RLT','','R');
					$pdf->Cell(15,5, (''),'RLT','','R');
					$pdf->Cell(15,5, (''),'RLT','','R');
