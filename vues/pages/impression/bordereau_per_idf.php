<?php
	...
	$pdf->Text(10, 32, utf8_decode("----------------------------------------------------------------------"));
			...
			$pdf->Cell(210,7, utf8_decode("BORDEREAU IDF/PERIODE "),'','','C'); 
			$pdf->Ln();
...
//================================= DONNEES RETOURNEES DU BORDEREAU==================
			...
			$s="select * from idf_paiement,client where idf_paiement.Client=client.Id_cl and Date_enr between '$dt' and '$dt2'";
...
//================ REDEVANCES AER===========================================================	
			...
			{	
				...
				do
				{
					...
					{
						$tva_cdf=tva($t['Mt']);
						$mht_cdf=$t['Mt']-$tva_cdf;
						$mttc_cdf=$mht_cdf+$tva_cdf;
						$tva_usd=0;
						$mht_usd=0;
						$mttc_usd=0;
					...
					{
						$tva_usd=tva($t['Mt']);
						$mht_usd=$t['Mt']-$tva_usd;
						$mttc_usd=$mht_usd+$tva_usd;
						$tva_cdf=0;
						$mht_cdf=0;
						$mttc_cdf=0;
					...
					{													
							...
							$pdf->Cell(20,5,arrondie($mht_usd),'LR','','R');
							$pdf->Cell(20,5,arrondie($mht_cdf),'R','','R');
							$pdf->Cell(20,5,arrondie($tva_usd),'R','','R');
							$pdf->Cell(20,5,arrondie($tva_cdf),'R','','R');
							$pdf->Cell(20,5,arrondie($mttc_usd),'R','','R');
							$pdf->Cell(20,5,arrondie($mttc_cdf),'R','','R');
