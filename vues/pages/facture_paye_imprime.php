<?php
	...
	$m=new main();
	$s="select TOP 200* from rva_facturation2.facture_paye_imprime where Valide='V' order by Id_impr desc";
	$e=$m->cnx->query($s);
	$t=$e->fetchAll();
	$n=count($t);
?>
<div class="panel panel-primary">
    ...
    <div class="panel-body">
    	<form onsubmit="reimpression_fact_paye_dt(); return false">
    	<div class="row">
        	<div class="col-md-4">
		...
		{ 
			...
			<tr class="w3-hover-grey">
                ...
                <td><?php echo (@$user['nom']); ?></td>
                 <td>
                 	<a href="#" onClick="reimprimer_fact_paye_conf(<?php echo $row['Mouv']; ?>);"><i class="fa fa-print"></i> Imprime</a>&nbsp;
